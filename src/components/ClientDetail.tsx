            ...
            <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-ink-faint">Cliente desde {formatDataHora(cliente.createdAt)}</p>
                </div>
              </div>
              <div className="flex flex-col gap-3 sm:items-end">
                ...
                {cliente.telefone ? (
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs font-semibold text-emerald-600 transition hover:bg-emerald-500/20"
                  >
                    WhatsApp
                  </a>
                ) : (
                  <span className="rounded-full border border-ink/10 bg-ink/5 px-3 py-2 text-xs text-ink-muted">Telefone não disponível</span>
                )}
              </div>
            </div>
